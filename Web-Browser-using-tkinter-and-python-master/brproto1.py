...
#photo=PhotoImage(file="E:\pycharm\Web-Browser-using-tkinter-and-python-master\IMG\cosmo.png")
label=Label(root)
label.pack(side=TOP)
...
b1.pack(side=LEFT)
# m1=PhotoImage(file="E:\pycharm\Web-Browser-using-tkinter-and-python-master\IMG\g.png")
# b1.config(image=m1)
...
b2.pack(side=LEFT)
# m2=PhotoImage(file="E:\pycharm\Web-Browser-using-tkinter-and-python-master\IMG\bing.png")
# b2.config(image=m2)
# tm2=m2.subsample(6,6)
# b2.config(image=tm2)
b3=ttk.Button(frame, command=lambda aurl=url3:OpenUrl(aurl))
b3.pack(side=LEFT)
# m3=PhotoImage(file="E:\pycharm\Web-Browser-using-tkinter-and-python-master\IMG\y.png")
# b3.config(image=m3)
# tm3=m3.subsample(6,6)
# b3.config(image=tm3)
b4=ttk.Button(root)
b4.pack(side=LEFT)
# m4=PhotoImage(file="E:\pycharm\Web-Browser-using-tkinter-and-python-master\IMG\favicon.png")
# b4.config(image=m4)
# tm4=m4.subsample(2,2)
#  b4.config(image=tm4)
b5=ttk.Button(root)
b5.pack(side=RIGHT)
# m5=PhotoImage(file="E:\pycharm\Web-Browser-using-tkinter-and-python-master\IMG\g.png")
# b5.config(image=m5)
